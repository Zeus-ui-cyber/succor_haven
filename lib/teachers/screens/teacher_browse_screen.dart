                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: active
                        ? [
                            BoxShadow(
                              color: _C.violet.withOpacity(0.28),
                              blurRadius: 8,
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: teacher.gradientB.withOpacity(0.4),
                            blurRadius: 10,
                            offset: const Offset(0, 4),
                          ),
                        ],
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: t.gradientB.withOpacity(0.35),
                        blurRadius: 16,
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: _C.violet.withOpacity(0.35),
                    blurRadius: 12,
                    offset: const Offset(0, 5),
                  ),
                ],
                ...
                Expanded(
                  child: Column(
                    children: [5, 4, 3, 2, 1].map((star) {
                      // Fake distribution weighted toward 5 stars
                      final pct = star == 5
                          ? 0.78
                          : star == 4
                          ? 0.16
          ...
          AnimatedBuilder(
            ...
            builder: (_, __) => Transform.scale(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  color: _C.green.withOpacity(_opacity.value),
                ),
              ),
            ),
          ),
